...
from racecar_gym.cnn_mod_env import RaceEnv
...
def create_env(scenario):
    def _init():
        ...
        base_env = RaceEnv(scenario = scenario )
...
if __name__ == '__main__':
    ...
    vec_env = SubprocVecEnv([create_env("austria_competition") for i in range(num_envs)])
    ...
    model.save("modified_car_model_austra_PPO_final")

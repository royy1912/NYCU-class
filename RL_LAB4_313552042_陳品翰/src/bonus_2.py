...
import numpy as np
from base_bonus2 import TD3BaseAgent
...
import random
from base_bonus2 import OUNoiseGenerator, GaussianNoise
...
class CarRacingTD3Agent(TD3BaseAgent):
	def __init__(self, config):
		...
		self.load('log/CarRacing/bonus_2/model_4112854_687.pth')
		# target network
	...
	def update_behavior_network(self):
		...
		with torch.no_grad():
			a_next = self.target_actor_net(next_state).squeeze(0).cpu().numpy()
